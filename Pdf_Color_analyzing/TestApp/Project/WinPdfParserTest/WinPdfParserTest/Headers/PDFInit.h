...
/**
	...
	@see ASMemAvailProc 
	@see ASMemFreeProc 
	@see ASMemReallocProc 
	@see PDFLInit 
*/
typedef void * (*ASMemAllocProc)(void *clientData, ASSize_t size);
...
/**
	...
	@see PDFLInit 
*/
typedef void* (*ASMemReallocProc)(void *clientData, void* p, ASSize_t size);
...
/**
	...
	@see PDFLInit 
*/
typedef void (*ASMemFreeProc)(void *clientData, void *p);
...
/**
	...
	@see PDFLInit 
*/
typedef ASSize_t (*ASMemAvailProc)(void *clientData);
