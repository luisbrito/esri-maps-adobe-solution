...
typedef struct {
	...
	*/
	...
	/** Deprecated. To pass the user specific values to control the flattening, use <code>flattenInfo</code>.
	*/
	...
	*/
	...
	/** When <code>true</code>, apply print-specific visibility state
	...
	*/
	ASBool TTasCIDT2;	/* when set, emit TrueType fonts as CIDType2 instead of as CIDFontType0 */
...
*/
	...
	*/
	...
	/**
		...
		@see PDDocPrintPages
	*/
	ACCBPROTO1 void (ACCBPROTO2 *EmitPSResourceBegin)(ASStm stm, ASAtom resType, char *resName, CosObj resObj, PDPrintClient printClient);
	...
	/**
		...
		@see PDDocPrintPages
	*/
	ACCBPROTO1 void (ACCBPROTO2 *EmitPSResourceEnd)(ASStm stm, ASAtom resType, char *resName, CosObj resObj, PDPrintClient printClient);
